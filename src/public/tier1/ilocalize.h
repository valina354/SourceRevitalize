...
template <typename T> class TypedKeyValuesStringHelper
{
public:
...
template <> class TypedKeyValuesStringHelper<char>
{
public:
...
template <> class TypedKeyValuesStringHelper<wchar_t>
{
public:
...
private:
	template <typename T> CLocalizedStringArg( T value, const locchar_t *loc_Format )
	{
