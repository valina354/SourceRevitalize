...
extern "C"
{
	...
	void VInvalidParameterHandler( const wchar_t *expression, const wchar_t *function, const wchar_t *file, unsigned int line, uintptr_t pReserved )
	{
...
public:
	_LocaleUpdate( _locale_t plocinfo ) : updated( false )
	{
		/*
                    if (plocinfo == NULL)
                    {
