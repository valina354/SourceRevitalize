...
enum RenderParamVector_t
{
	...
	VECTOR_RENDERPARM_CASCADED_FORWARD,
...
enum RenderParamInt_t
{
	...
	INT_RENDERPARM_CASCADED_DEPTHTEXTURE,
	INT_RENDERPARM_CASCADED_MATRIX_ADDRESS_0,
