...
{
public:
	typedef IMaterialSystem BaseClass;
...
public:
	...
	virtual ITexture* FindTexture(char const* pTextureName, const char* pTextureGroupName, bool complain = true, int nAdditionalCreationFlags = 0)  { return m_pBaseMaterialsPassThru->FindTexture(pTextureName, pTextureGroupName, complain, nAdditionalCreationFlags); }
