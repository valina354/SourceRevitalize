...
public:
	...
	//VANCE specific functions
	void						DrawIconProgressBar2ColorVanceSpecific(int x, int y, const char* fontName, wchar_t value, float percentage, Color& clr, Color& clr2, int type);
	void DrawSelfCropped_VANCESpecific(int x, int y, int cropx, int cropy, int cropw, float croph, wchar_t cCharacterInFont, Color clr, vgui::HFont hudFont);
