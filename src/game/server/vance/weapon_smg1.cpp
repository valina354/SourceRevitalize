...
class CWeaponSMG1 : public CVanceMachineGun
{
	DECLARE_CLASS(CWeaponSMG1, CVanceMachineGun);
	DECLARE_SERVERCLASS();
	DECLARE_DATADESC();
	DECLARE_ACTTABLE();
public:
...
int CWeaponSMG1::WeaponRangeAttack1Condition(float flDot, float flDist)
{
	if (m_iClip1 <= 0)
	{
