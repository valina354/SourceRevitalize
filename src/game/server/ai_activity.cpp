...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_CROUCHWALK);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIRSTDRAW);
	ADD_ACTIVITY_TO_SR(ACT_VM_LAND);
	ADD_ACTIVITY_TO_SR(ACT_VM_KICK);
	ADD_ACTIVITY_TO_SR(ACT_VM_EXTEND);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_DRAW_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOAD_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIRE_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_WALK_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_CROUCHWALK_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_HOLSTER_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_FIDGET_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RETRACT);

	ADD_ACTIVITY_TO_SR(ACT_VM_SWING_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_VM_SWING_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_TO_THROW);
	ADD_ACTIVITY_TO_SR(ACT_VM_THROW_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_THROW_TO_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_ENTER_EXTENDED);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_LEAVE_EXTENDED);
#endif
}
