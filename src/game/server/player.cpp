...
void CC_GiveCurrentAmmo( void )
{
	...
	if( pPlayer )
	{
		...
		if( pWeapon )
		{
			if (pWeapon->m_pSwitchingTo) //if we are switching weapons give the ammo to whichever weapon we are switching to, not the gun thats being holstered
				pWeapon = pWeapon->m_pSwitchingTo;
