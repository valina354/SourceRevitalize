...
// Team Fortress specific - medic heal, medic infect, etc.....
	...
	ACT_MELEE_VM_INSPECT_END,
		...
		ACT_VM_CROUCHWALK_EXTENDED,
		ACT_VM_HOLSTER_EXTENDED,
		ACT_VM_KICK_EXTENDED,
		ACT_VM_FIDGET_EXTENDED,
		ACT_VM_RETRACT,

		ACT_VM_INSPECT,
		ACT_VM_INSPECT_EXTENDED,

		ACT_VM_SWING_LEFT,
		ACT_VM_SWING_RIGHT,
		ACT_VM_IDLE_TO_THROW,
		ACT_VM_THROW_IDLE,
		ACT_VM_THROW_TO_IDLE,
		...
		ACT_VM_SLIDE,
		ACT_VM_SLIDE_EXTENDED,

		ACT_SHOTGUN_RELOAD_ONE_EMPTY,

		ACT_VM_SPRINT_ENTER_EXTENDED,
		ACT_VM_SPRINT_LEAVE_EXTENDED,
#endif
