...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT(AE_WPN_FULLCLIP1, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_WPN_STAGE_ONEBULLET, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_WEAPON_ALLOWFIRE, AE_TYPE_SERVER);
#ifdef VANCE
	REGISTER_SHARED_ANIMEVENT(AE_SV_STARTHEAL, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_SV_SWING, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_MELEE_THROW, AE_TYPE_SERVER);
