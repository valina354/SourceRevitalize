...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_CROUCHWALK );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SPRINT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_FIRSTDRAW );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LAND );
	REGISTER_SHARED_ACTIVITY( ACT_VM_KICK );
	REGISTER_SHARED_ACTIVITY( ACT_VM_EXTEND );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SPRINT_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_FIRE_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_WALK_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_CROUCHWALK_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_HOLSTER_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_KICK_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RETRACT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SWING_LEFT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SWING_RIGHT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_IDLE_TO_THROW );
	REGISTER_SHARED_ACTIVITY( ACT_VM_THROW_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_CLIMB );
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SLIDE_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_VM_INSPECT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_INSPECT_EXTENDED );
	REGISTER_SHARED_ACTIVITY( ACT_SHOTGUN_RELOAD_ONE_EMPTY );
#endif
