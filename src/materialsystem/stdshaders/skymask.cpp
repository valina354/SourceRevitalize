...
BEGIN_VS_SHADER( fill_viewmask, "" )
	BEGIN_SHADER_PARAMS
	SHADER_PARAM( BASETEXTURE2, SHADER_PARAM_TYPE_TEXTURE, "_rt_FullFrameFB", "" )
	SHADER_PARAM( COMBINEMODE, SHADER_PARAM_TYPE_INTEGER, "1", "" )
	SHADER_PARAM( VIEWMODEL, SHADER_PARAM_TYPE_BOOL, "1.0", "" )
	END_SHADER_PARAMS
