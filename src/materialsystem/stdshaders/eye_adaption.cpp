...
#include "eye_adaption_ps30.inc"

BEGIN_VS_SHADER_FLAGS( Eye_Adaption, "Help for Bloom", SHADER_NOT_EDITABLE )
BEGIN_SHADER_PARAMS
...
SHADER_DRAW
{
	SHADOW_STATE
	{
		...
		{
			DECLARE_STATIC_PIXEL_SHADER( eye_adaption_ps30 );
			SET_STATIC_PIXEL_SHADER( eye_adaption_ps30 );
		}
	}
	...
	DYNAMIC_STATE
	{
		...
		//if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
		{
			DECLARE_DYNAMIC_PIXEL_SHADER( eye_adaption_ps30 );
			SET_DYNAMIC_PIXEL_SHADER( eye_adaption_ps30 );
		}
	}
	Draw();
}
