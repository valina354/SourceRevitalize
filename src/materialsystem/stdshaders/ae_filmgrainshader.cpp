...
SHADER_DRAW
{
	SHADOW_STATE
	{
		...
		//Set Pixel shader
		DECLARE_STATIC_PIXEL_SHADER( ae_filmgrain_ps30 );
		SET_STATIC_PIXEL_SHADER( ae_filmgrain_ps30 );
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_PIXEL_SHADER( ae_filmgrain_ps30 );
		SET_DYNAMIC_PIXEL_SHADER( ae_filmgrain_ps30 );
	}
	Draw();
}
END_SHADER