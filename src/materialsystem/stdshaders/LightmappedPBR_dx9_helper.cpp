...
// Draws the shader
//-----------------------------------------------------------------------------
static void DrawLightmappedPBR_DX9_Internal( CBaseVSShader *pShader, IMaterialVar **params, IShaderDynamicAPI *pShaderAPI, IShaderShadow *pShaderShadow, bool bHasFlashlight, LightmappedPBR_DX9_Vars_t &info, VertexCompressionType_t vertexCompression, CBasePerMaterialContextData **pContextDataPtr )
{
	...
	if ( pShader->IsSnapshotting() )
	{
		...
		SET_STATIC_VERTEX_SHADER_COMBO( DISPLACEMENTMAPPING, bHasDisplacement );
	...
	else // not snapshotting -- begin dynamic state
	{
		...
		pShaderAPI->SetVertexShaderConstant( VERTEX_SHADER_SHADER_SPECIFIC_CONST_10, params[info.DisplacementDepth]->GetVecValue() );
