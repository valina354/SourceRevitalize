...
#include "SDK_WaterCheap_vs30.inc"
#include "SDK_WaterCheap_ps30.inc"
#include "SDK_Water_vs30.inc"
#include "SDK_Water_ps30.inc"

#include "flowmapped_water_ps30.inc"
...
BEGIN_VS_SHADER( SDK_Water_DX90, 
		...
		IShaderDynamicAPI* pShaderAPI, bool bReflection, bool bRefraction, bool hasFlashlight)
	{
		...
		if (bDoDraw)
		{
			if (pShaderShadow)
			{
				...
				DECLARE_STATIC_VERTEX_SHADER(flowmapped_water_vs30);
				...
				SET_STATIC_VERTEX_SHADER(flowmapped_water_vs30);
				...
				{
					DECLARE_STATIC_PIXEL_SHADER(flowmapped_water_ps30);
					...
					SET_STATIC_PIXEL_SHADER(flowmapped_water_ps30);
				}
			...
			if (pShaderAPI)
			{
				...
				DECLARE_DYNAMIC_VERTEX_SHADER(flowmapped_water_vs30);
				SET_DYNAMIC_VERTEX_SHADER(flowmapped_water_vs30);
				...
				//if (g_pHardwareConfig->SupportsPixelShaders_2_b())
				{
					DECLARE_DYNAMIC_PIXEL_SHADER(flowmapped_water_ps30);
					SET_DYNAMIC_PIXEL_SHADER_COMBO(FLASHLIGHTSHADOWS, bFlashlightShadows);
					SET_DYNAMIC_PIXEL_SHADER_COMBO(PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo());
					SET_DYNAMIC_PIXEL_SHADER_COMBO(WRITE_DEPTH_TO_DESTALPHA, pShaderAPI->ShouldWriteDepthToDestAlpha());
					SET_DYNAMIC_PIXEL_SHADER(flowmapped_water_ps30);
				}
			}
		}
		Draw(bDoDraw);
		...
		IShaderDynamicAPI* pShaderAPI, bool bReflection, bool bRefraction ) 
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( sdk_water_vs30 );
			...
			SET_STATIC_VERTEX_SHADER( sdk_water_vs30 );
			...
			if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_STATIC_PIXEL_SHADER( sdk_water_ps30 );
				...
				SET_STATIC_PIXEL_SHADER( sdk_water_ps30 );
			}
			else
			{
				DECLARE_STATIC_PIXEL_SHADER( sdk_water_ps30 );
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( sdk_water_vs30 );
			SET_DYNAMIC_VERTEX_SHADER( sdk_water_vs30 );
			
			if ( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( sdk_water_ps30 );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( WRITE_DEPTH_TO_DESTALPHA, pShaderAPI->ShouldWriteDepthToDestAlpha() );
				SET_DYNAMIC_PIXEL_SHADER( sdk_water_ps30 );
			}
			else
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( sdk_water_ps30 );
		                        ...
		                        IShaderDynamicAPI* pShaderAPI, bool bBlend, bool bRefraction )
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( sdk_watercheap_vs30 );
			SET_STATIC_VERTEX_SHADER_COMBO( BLEND,  bBlend && bRefraction );
			SET_STATIC_VERTEX_SHADER( sdk_watercheap_vs30 );

			if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_STATIC_PIXEL_SHADER( sdk_watercheap_ps30 );
				...
				SET_STATIC_PIXEL_SHADER_COMBO( MULTITEXTURE,fabs(Scroll1.x) > 0.0);
				SET_STATIC_PIXEL_SHADER_COMBO( NORMAL_DECODE_MODE, (int) nNormalDecodeMode );
				SET_STATIC_PIXEL_SHADER( sdk_watercheap_ps30 );
			}
			else
			{
				DECLARE_STATIC_PIXEL_SHADER( sdk_watercheap_ps30 );
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( sdk_watercheap_vs30 );
			SET_DYNAMIC_VERTEX_SHADER( sdk_watercheap_vs30 );

			if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( sdk_watercheap_ps30 );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( HDRENABLED,  IsHDREnabled() );
				SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
				SET_DYNAMIC_PIXEL_SHADER( sdk_watercheap_ps30 );
			}
			else
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( sdk_watercheap_ps30 );
