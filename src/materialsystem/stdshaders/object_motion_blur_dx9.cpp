...
#include "object_motion_blur_vs30.inc"
#include "object_motion_blur_ps30.inc"
...
BEGIN_VS_SHADER_FLAGS( ObjectMotionBlur, "Object Motion Blur", SHADER_NOT_EDITABLE )
	...
	SHADER_DRAW
	{
		SHADOW_STATE 
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( object_motion_blur_vs30 );
			SET_STATIC_VERTEX_SHADER( object_motion_blur_vs30 );

			DECLARE_STATIC_PIXEL_SHADER( object_motion_blur_ps30 );
			SET_STATIC_PIXEL_SHADER( object_motion_blur_ps30 );
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( object_motion_blur_vs30 );
			SET_DYNAMIC_VERTEX_SHADER( object_motion_blur_vs30 );

			Assert( g_pHardwareConfig->SupportsPixelShaders_2_b() );
			DECLARE_DYNAMIC_PIXEL_SHADER( object_motion_blur_ps30 );
			SET_DYNAMIC_PIXEL_SHADER( object_motion_blur_ps30 );
		}
