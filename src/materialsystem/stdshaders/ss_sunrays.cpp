...
BEGIN_VS_SHADER( SS_Sunrays, "Help for SS_Sunrays" ) //Begin the shader
	...
	BEGIN_SHADER_PARAMS
	SHADER_PARAM(SUNX, SHADER_PARAM_TYPE_FLOAT, "1", "")
	SHADER_PARAM(SUNY, SHADER_PARAM_TYPE_FLOAT, "1", "")
	SHADER_PARAM(SUNZ, SHADER_PARAM_TYPE_FLOAT, "1", "")
	SHADER_PARAM(SUNCOLOR, SHADER_PARAM_TYPE_VEC3, "1", "")
