...
static ConVar r_shader_srgb( "r_shader_srgb", "0", FCVAR_CHEAT, "-1 = use hardware caps. 0 = use hardware srgb. 1 = use shader srgb(software lookup)" );		// -1=use caps 0=off 1=on
...
static ConVar mat_disablehwmorph( "mat_disablehwmorph", "0", FCVAR_CHEAT, "Disables HW morphing for particular mods" );
