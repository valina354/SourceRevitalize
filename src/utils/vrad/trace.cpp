...
void TestLine_IgnoreSky( const FourVectors &start, const FourVectors &stop, fltx4 *pFractionVisible, int static_prop_index_to_ignore )
{
	FourRays myrays;
	myrays.origin = start;
	myrays.direction = stop;
	...
	{
		visibility[i] = 1.0f;
		if ( ( rt_result.HitIds[i] != -1 ) && ( HitDistancef[i] < lenf[i] ) )
		{
